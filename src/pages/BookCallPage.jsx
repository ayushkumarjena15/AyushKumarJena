        ...
        >
            ...
            <div className="w-full md:w-[32%] p-6 md:p-10 border-b md:border-b-0 md:border-r border-white/5 bg-[#181818]/50 flex flex-col gap-8 md:gap-10">
                <div className="space-y-6">
                    <img src="/profile.webp" className="w-14 h-14 rounded-full border border-white/10 shadow-2xl" alt="Ayush" />
        ...
        >
            <div className="w-full md:w-[40%] p-10 bg-[#181818]/50 border-r border-white/5 flex flex-col gap-10">
                ...
                <div className="space-y-8">
                    <img src="/profile.webp" className="w-16 h-16 rounded-full border border-white/10" alt="Ayush" />
        ...
        <section className="min-h-screen bg-background pt-32 pb-40 max-w-7xl mx-auto relative overflow-visible px-4">
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}
                ...
                <motion.div className="mt-8 lg:mt-0 relative w-[240px] h-[240px] md:w-[380px] md:h-[380px] rounded-[3rem] md:rounded-[3.5rem] overflow-hidden flex-shrink-0 group mx-auto lg:mx-0 shadow-2xl border border-white/5 order-last lg:order-none">
                    <img src="/profile.webp" alt="Profile" className="w-full h-full object-cover transition-all duration-1000 group-hover:scale-105 group-hover:rotate-2" />
