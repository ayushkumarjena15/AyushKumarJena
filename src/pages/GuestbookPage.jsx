                ...
                <div className="flex items-center gap-3 flex-wrap">
                    ...
                    {liked_by && (
                        <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-[#ec4899] text-[10px] font-medium whitespace-nowrap">Liked by {liked_by.split(' ')[0].charAt(0).toUpperCase() + liked_by.split(' ')[0].slice(1).toLowerCase()}</span>
                        </div>
                    )}
                    {is_hidden && (
                        <div className="flex items-center gap-1.5">
    ...
    return (
        ...
        >
            <section className="min-h-screen pt-24 pb-20 px-6 max-w-7xl mx-auto relative overflow-hidden">
                ...
                {/* Input Form Section */}
                {user && (
                    <div className="w-full max-w-3xl mx-auto bg-[#0a0a0a] border border-white/5 rounded-3xl p-6 relative overflow-hidden transition-all mb-16 shadow-[0_0_30px_rgba(255,149,0,0.02)]">
                        <form onSubmit={submitSignature} className="flex flex-col">
                            ...
                            <div className="flex items-center justify-between mt-2 pt-4 pl-14">
                                ...
                                <button
                                    ...
                                    className="relative group h-12 px-8 rounded-full overflow-hidden transition-all duration-500 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                                >
                                    {/* Animated Background */}
                                    ...
                                    <div className="absolute inset-0 bg-[#1a1a1a] group-hover:bg-transparent transition-colors duration-500 border border-white/10 group-hover:border-transparent rounded-full" />

                                    {/* Content Wrapper */}
                                    <div className="relative flex items-center gap-2">
                                        <span className="text-white/80 group-hover:text-white font-bold text-xs uppercase tracking-widest transition-colors duration-300">Sign Guestbook</span>
                                        {isSubmitting ? (
                                            <Loader2 size={14} className="animate-spin text-white" />
                                        ) : (
                                            <Send size={14} className="text-white/40 group-hover:text-white transition-colors duration-300" />
                                        )}
                                    </div>
                                </button>
                            </div>
